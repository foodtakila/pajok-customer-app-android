...
public class CommonUtilities {
    ...
    public static final String idNo = "85";
    public static final String bNumber = "22551";
    public static final String pName = "pajok";
    public static final String SERVER = "https://pajok.com/";
