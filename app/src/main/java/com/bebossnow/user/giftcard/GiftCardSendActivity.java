package com.bebossnow.user.giftcard;
...
import com.bebossnow.user.databinding.ActivityGiftcardSendBinding;
import com.bebossnow.user.giftcard.adapter.GiftCardImagePagerAdapter;
