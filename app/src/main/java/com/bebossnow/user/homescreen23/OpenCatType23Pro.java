package com.bebossnow.user.homescreen23;
...
import com.bebossnow.user.RequestBidInfoActivity;
import com.bebossnow.user.deliverAll.FoodDeliveryHomeActivity;
import com.bebossnow.user.deliverAll.GenieDeliveryHomeActivity;
import com.bebossnow.user.deliverAll.RestaurantAllDetailsNewActivity;
import com.bebossnow.user.nearbyservice.NearByServicesActivity;
import com.bebossnow.user.rentItem.RentItemHomeActivity;
import com.bebossnow.user.rideSharing.RideBook;
import com.bebossnow.user.rideSharing.RideMyList;
import com.bebossnow.user.rideSharing.RidePublish;
import com.bebossnow.user.trackService.TrackAnyList;
import com.bebossnow.user.trackService.TrackAnyProfileSetup;
