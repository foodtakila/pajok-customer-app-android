...
import com.bebossnow.user.BookingActivity;
import com.bebossnow.user.BusinessProfileActivity;
import com.bebossnow.user.ContactUsActivity;
import com.bebossnow.user.DonationActivity;
import com.bebossnow.user.EmergencyContactActivity;
import com.bebossnow.user.FavouriteDriverActivity;
import com.bebossnow.user.HelpActivity23Pro;
import com.bebossnow.user.InviteFriendsActivity;
import com.bebossnow.user.ManageAccountActivity;
import com.bebossnow.user.MenuSettingActivity;
import com.bebossnow.user.MobileStegeActivity;
import com.bebossnow.user.MyProfileActivity;
import com.bebossnow.user.MyWalletActivity;
import com.bebossnow.user.NotificationActivity;
...
import com.bebossnow.user.StaticPageActivity;
import com.bebossnow.user.VerifyInfoActivity;
import com.bebossnow.user.deliverAll.EditCartActivity;
import com.bebossnow.user.giftcard.GiftCardRedeemActivity;
import com.bebossnow.user.giftcard.GiftCardSendActivity;
import com.bebossnow.user.rentItem.RentItemListPostActivity;
