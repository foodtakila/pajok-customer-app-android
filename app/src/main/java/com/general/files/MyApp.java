...
import com.bebossnow.user.AccountverificationActivity;
import com.bebossnow.user.AddAddressActivity;
import com.bebossnow.user.AdditionalChargeActivity;
import com.bebossnow.user.AppRestrictedActivity;
import com.bebossnow.user.BuildConfig;
import com.bebossnow.user.CarWashBookingDetailsActivity;
import com.bebossnow.user.CommonDeliveryTypeSelectionActivity;
import com.bebossnow.user.LauncherActivity;
import com.bebossnow.user.MainActivity;
import com.bebossnow.user.NetworkChangeReceiver;
import com.bebossnow.user.OnGoingTripDetailsActivity;
import com.bebossnow.user.PaymentWebviewActivity;
import com.bebossnow.user.R;
import com.bebossnow.user.RentalDetailsActivity;
import com.bebossnow.user.RideDeliveryActivity;
import com.bebossnow.user.SearchPickupLocationActivity;
import com.bebossnow.user.UberXActivity;
import com.bebossnow.user.UberXHomeActivity;
import com.bebossnow.user.deliverAll.FoodDeliveryHomeActivity;
import com.bebossnow.user.deliverAll.TrackOrderActivity;
...
//            InputStreamReader inputStreamReader = new InputStreamReader(getResources().openRawResource(R.raw.config_data));
    ...
    private void registerReceiver() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            this.registerReceiver(this.mGpsReceiver, mIntentFilter, Context.RECEIVER_NOT_EXPORTED);
        } else {
...
//                mIntentFilter.addAction("android.net.wifi.WIFI_STATE_CHANGED");
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                    this.registerReceiver(this.mNetWorkReceiver, mIntentFilter, Context.RECEIVER_NOT_EXPORTED); // Or RECEIVER_EXPORTED
                } else {
