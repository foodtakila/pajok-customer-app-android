...
import com.bebossnow.user.BiddingTaskActivity;
import com.bebossnow.user.BookingActivity;
import com.bebossnow.user.ChatActivity;
import com.bebossnow.user.ConfirmEmergencyTapActivity;
import com.bebossnow.user.HistoryDetailActivity;
import com.bebossnow.user.MainActivity;
import com.bebossnow.user.OnGoingTripDetailsActivity;
import com.bebossnow.user.OnGoingTripsActivity;
import com.bebossnow.user.PaymentWebviewActivity;
import com.bebossnow.user.RatingActivity;
import com.bebossnow.user.UberXHomeActivity;
import com.bebossnow.user.deliverAll.OrderPlaceConfirmActivity;
import com.bebossnow.user.deliverAll.TrackOrderActivity;
import com.bebossnow.user.rentItem.RentItemListPostActivity;
import com.bebossnow.user.rideSharing.RideBookingRequestedActivity;
import com.bebossnow.user.trackService.PairCodeGenrateActivity;
import com.bebossnow.user.trackService.TrackAnyList;
import com.bebossnow.user.trackService.TrackAnyLiveTracking;
